export const metadata = {
  title: "Privacy Policy | Rent vs Buy Estimator",
  description: "Privacy policy for Rent vs Buy Estimator. Learn how we handle data, cookies, and third-party services including Google AdSense and Google Analytics.",
  ...
  return (
    <main style={{ maxWidth: "780px", margin: "0 auto", padding: "2rem 1.5rem", fontFamily: "'DM Mono', monospace", color: "#1a1a1a", background: "#faf8f4", minHeight: "100vh" }}>
      <p style={{ fontSize: "12px", marginBottom: "1.5rem" }}>
        <a href="/" style={{ color: "#d97706", textDecoration: "none" }}>← Back to Rent vs Buy Estimator</a>
      </p>
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ fontSize: "13px", lineHeight: "1.8", color: "#444" }}>
          We do not collect, store, or transmit any financial data you enter into this tool. The rent amounts, home prices, down payments, and other values you type are processed entirely within your browser. Nothing you enter is sent to our servers, stored in a database, or shared with any third party. We do not require you to create an account or provide an email address to use this tool.
        </p>
      </section>
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ fontSize: "13px", lineHeight: "1.8", color: "#444", marginTop: ".75rem" }}>
          ...
          <a href="https://www.google.com/settings/ads" style={{ color: "#d97706" }} target="_blank" rel="noopener noreferrer">Google Ads Settings</a>.
          For more information on how Google uses data from sites that use its advertising services, visit{" "}
          <a href="https://policies.google.com/technologies/partner-sites" style={{ color: "#d97706" }} target="_blank" rel="noopener noreferrer">How Google uses information from sites or apps that use our services</a>.
        </p>
      </section>
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ fontSize: "13px", lineHeight: "1.8", color: "#444", marginTop: ".75rem" }}>
          ...
          <a href="https://tools.google.com/dlpage/gaoptout" style={{ color: "#d97706" }} target="_blank" rel="noopener noreferrer">Google Analytics Opt-out Browser Add-on</a>.
        </p>
      </section>
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ fontSize: "13px", lineHeight: "1.8", color: "#444" }}>
          ...
          <a href="https://myaccount.google.com" style={{ color: "#d97706" }} target="_blank" rel="noopener noreferrer">Google Account settings</a>.
        </p>
      </section>
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ fontSize: "13px", lineHeight: "1.8", color: "#444" }}>
          ...
          <a href="https://moneywisecalculator.com" style={{ color: "#d97706" }}>MoneyWise Calculator</a>.
        </p>
      </section>
